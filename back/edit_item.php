<!-- 0214 複製add_item.php 增加find($_GET['id']) 並在每格後面加上value-->
<h2 class="ct">修改商品</h2>
<?php
// 實際應用要判斷是否有帶id
...
<form action="./api/save_item.php" method="post" enctype="multipart/form-data">
    <table class="all">
        ...
        <tr>
            ...
            <td class="pp"><input type="int" name="stock" id="stock" value="<?= $item['stock']; ?> "></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="pp"><textarea cols="30" rows="10" name="intro" id="intro"><?= $item['intro']; ?> </textarea></td>
        </tr>
    </table>
    <div class="ct">
